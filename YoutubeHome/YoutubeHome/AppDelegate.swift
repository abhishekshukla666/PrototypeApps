...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let rootVC = ViewController(collectionViewLayout: layout)
        ...
        window?.addConstraintsWithFormat("H:|[v0]|", views: statusBarView)
        let height = application.statusBarFrame.height
        window?.addConstraintsWithFormat("V:[v0(\(height))]", views: statusBarView)
        return true
    }
